...
static vlc_fourcc_t Lookup(vlc_fourcc_t fourcc, const char ** dsc,
...
static vlc_fourcc_t LookupAudio(vlc_fourcc_t fourcc, const char ** dsc)
{
...
static vlc_fourcc_t LookupSpu(vlc_fourcc_t fourcc, const char ** dsc)
{
