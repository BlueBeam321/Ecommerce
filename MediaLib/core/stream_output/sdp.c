...
static void vsdp_AddAttribute(struct vlc_memstream* stream, const char *name, const char *fmt, va_list ap)
{
...
void sdp_AddAttribute(struct vlc_memstream* stream, const char *name, const char *fmt, ...)
{
    va_list ap;
...
void sdp_AddMedia(struct vlc_memstream* stream,
...
int vlc_sdp_Start(struct vlc_memstream* stream,
                  ...
                  const struct sockaddr *addr, size_t addrlen)
{
    ...
    char varname[1024/*cfglen + sizeof("description")*/];
