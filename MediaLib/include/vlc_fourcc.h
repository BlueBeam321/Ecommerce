...
//VOD Lib FourCC
#define MX_ELEMENT_VIDEO			VLC_FOURCC('v','i','d','e')
#define MX_ELEMENT_AUDIO			VLC_FOURCC('a','u','d','e')
#define MX_ELEMENT_SPU				VLC_FOURCC('s','p','u','e')
#define MX_ELEMENT_DATA				VLC_FOURCC('d','a','t','e')


/* Video codec */
#define MX_CODEC_MPGV               VLC_FOURCC('m','p','g','v')
#define MX_CODEC_MP4V               VLC_FOURCC('m','p','4','v')
#define MX_CODEC_MP1V               VLC_FOURCC('m','p','1','v')
#define MX_CODEC_MP2V               VLC_FOURCC('m','p','2','v')
#define MX_CODEC_DIV1               VLC_FOURCC('D','I','V','1')
#define MX_CODEC_DIV2               VLC_FOURCC('D','I','V','2')
#define MX_CODEC_DIV3               VLC_FOURCC('D','I','V','3')
#define MX_CODEC_SVQ1               VLC_FOURCC('S','V','Q','1')
#define MX_CODEC_SVQ3               VLC_FOURCC('S','V','Q','3')
#define MX_CODEC_H264               VLC_FOURCC('h','2','6','4')
#define MX_CODEC_H263               VLC_FOURCC('h','2','6','3')
#define MX_CODEC_H263I              VLC_FOURCC('I','2','6','3')
#define MX_CODEC_H263P              VLC_FOURCC('I','L','V','R')
#define MX_CODEC_FLV1               VLC_FOURCC('F','L','V','1')
#define MX_CODEC_H261               VLC_FOURCC('h','2','6','1')
#define MX_CODEC_MJPG               VLC_FOURCC('M','J','P','G')
#define MX_CODEC_MJPGB              VLC_FOURCC('m','j','p','b')
#define MX_CODEC_LJPG               VLC_FOURCC('L','J','P','G')
#define MX_CODEC_WMV1               VLC_FOURCC('W','M','V','1')
#define MX_CODEC_WMV2               VLC_FOURCC('W','M','V','2')
#define MX_CODEC_WMV3               VLC_FOURCC('W','M','V','3')
#define MX_CODEC_WMVA               VLC_FOURCC('W','M','V','A')
#define MX_CODEC_WMVP               VLC_FOURCC('W','M','V','P')
#define MX_CODEC_WMVP2              VLC_FOURCC('W','V','P','2')
#define MX_CODEC_VC1                VLC_FOURCC('V','C','-','1')
#define MX_CODEC_DAALA              VLC_FOURCC('d','a','a','l')
#define MX_CODEC_THEORA             VLC_FOURCC('t','h','e','o')
#define MX_CODEC_TARKIN             VLC_FOURCC('t','a','r','k')
#define MX_CODEC_SNOW               VLC_FOURCC('S','N','O','W') // ???
#define MX_CODEC_DIRAC              VLC_FOURCC('d','r','a','c')
#define MX_CODEC_OGGSPOTS           VLC_FOURCC('S','P','O','T')
#define MX_CODEC_CAVS               VLC_FOURCC('C','A','V','S')
#define MX_CODEC_NUV                VLC_FOURCC('N','J','P','G')
#define MX_CODEC_RV10               VLC_FOURCC('R','V','1','0')
#define MX_CODEC_RV13               VLC_FOURCC('R','V','1','3')
#define MX_CODEC_RV20               VLC_FOURCC('R','V','2','0')
#define MX_CODEC_RV30               VLC_FOURCC('R','V','3','0')
#define MX_CODEC_RV40               VLC_FOURCC('R','V','4','0')
#define MX_CODEC_VP3                VLC_FOURCC('V','P','3',' ')
#define MX_CODEC_VP5                VLC_FOURCC('V','P','5',' ')
#define MX_CODEC_VP6                VLC_FOURCC('V','P','6','2')
#define MX_CODEC_VP6F               VLC_FOURCC('V','P','6','F')
#define MX_CODEC_VP6A               VLC_FOURCC('V','P','6','A')
#define MX_CODEC_MSVIDEO1           VLC_FOURCC('M','S','V','C')
#define MX_CODEC_FLIC               VLC_FOURCC('F','L','I','C')
#define MX_CODEC_SP5X               VLC_FOURCC('S','P','5','X')
#define MX_CODEC_DV                 VLC_FOURCC('d','v',' ',' ')
#define MX_CODEC_MSRLE              VLC_FOURCC('m','r','l','e')
#define MX_CODEC_HUFFYUV            VLC_FOURCC('H','F','Y','U')
#define MX_CODEC_FFVHUFF            VLC_FOURCC('F','F','V','H')
#define MX_CODEC_ASV1               VLC_FOURCC('A','S','V','1')
#define MX_CODEC_ASV2               VLC_FOURCC('A','S','V','2')
#define MX_CODEC_FFV1               VLC_FOURCC('F','F','V','1')
#define MX_CODEC_VCR1               VLC_FOURCC('V','C','R','1')
#define MX_CODEC_CLJR               VLC_FOURCC('C','L','J','R')
#define MX_CODEC_RPZA               VLC_FOURCC('r','p','z','a')
#define MX_CODEC_SMC                VLC_FOURCC('s','m','c',' ')
#define MX_CODEC_CINEPAK            VLC_FOURCC('C','V','I','D')
#define MX_CODEC_TSCC               VLC_FOURCC('T','S','C','C')
#define MX_CODEC_CSCD               VLC_FOURCC('C','S','C','D')
#define MX_CODEC_ZMBV               VLC_FOURCC('Z','M','B','V')
#define MX_CODEC_VMNC               VLC_FOURCC('V','M','n','c')
#define MX_CODEC_FMVC               VLC_FOURCC('F','M','V','C')
#define MX_CODEC_FRAPS              VLC_FOURCC('F','P','S','1')
#define MX_CODEC_TRUEMOTION1        VLC_FOURCC('D','U','C','K')
#define MX_CODEC_TRUEMOTION2        VLC_FOURCC('T','M','2','0')
#define MX_CODEC_QTRLE              VLC_FOURCC('r','l','e',' ')
#define MX_CODEC_QDRAW              VLC_FOURCC('q','d','r','w')
#define MX_CODEC_QPEG               VLC_FOURCC('Q','P','E','G')
#define MX_CODEC_ULTI               VLC_FOURCC('U','L','T','I')
#define MX_CODEC_VIXL               VLC_FOURCC('V','I','X','L')
#define MX_CODEC_LOCO               VLC_FOURCC('L','O','C','O')
#define MX_CODEC_WNV1               VLC_FOURCC('W','N','V','1')
#define MX_CODEC_AASC               VLC_FOURCC('A','A','S','C')
#define MX_CODEC_INDEO2             VLC_FOURCC('I','V','2','0')
#define MX_CODEC_INDEO3             VLC_FOURCC('I','V','3','1')
#define MX_CODEC_INDEO4             VLC_FOURCC('I','V','4','1')
#define MX_CODEC_INDEO5             VLC_FOURCC('I','V','5','0')
#define MX_CODEC_FLASHSV            VLC_FOURCC('F','S','V','1')
#define MX_CODEC_KMVC               VLC_FOURCC('K','M','V','C')
#define MX_CODEC_SMACKVIDEO         VLC_FOURCC('S','M','K','2')
#define MX_CODEC_DNXHD              VLC_FOURCC('A','V','d','n')
#define MX_CODEC_8BPS               VLC_FOURCC('8','B','P','S')
#define MX_CODEC_MIMIC              VLC_FOURCC('M','L','2','O')
#define MX_CODEC_INTERPLAY          VLC_FOURCC('i','m','v','e')
#define MX_CODEC_IDCIN              VLC_FOURCC('I','D','C','I')
#define MX_CODEC_4XM                VLC_FOURCC('4','X','M','V')
#define MX_CODEC_ROQ                VLC_FOURCC('R','o','Q','v')
#define MX_CODEC_MDEC               VLC_FOURCC('M','D','E','C')
#define MX_CODEC_VMDVIDEO           VLC_FOURCC('V','M','D','V')
#define MX_CODEC_CDG                VLC_FOURCC('C','D','G',' ')
#define MX_CODEC_FRWU               VLC_FOURCC('F','R','W','U')
#define MX_CODEC_AMV                VLC_FOURCC('A','M','V',' ')
#define MX_CODEC_VP7                VLC_FOURCC('V','P','7','0')
#define MX_CODEC_VP8                VLC_FOURCC('V','P','8','0')
#define MX_CODEC_VP9                VLC_FOURCC('V','P','9','0')
#define MX_CODEC_VP10               VLC_FOURCC('V','P',':','0')
#define MX_CODEC_AV1                VLC_FOURCC('a','v','1','0')
#define MX_CODEC_JPEG2000           VLC_FOURCC('J','P','2','K')
#define MX_CODEC_LAGARITH           VLC_FOURCC('L','A','G','S')
#define MX_CODEC_FLASHSV2           VLC_FOURCC('F','S','V','2')
#define MX_CODEC_PRORES             VLC_FOURCC('a','p','c','n')
#define MX_CODEC_MXPEG              VLC_FOURCC('M','X','P','G')
#define MX_CODEC_CDXL               VLC_FOURCC('C','D','X','L')
#define MX_CODEC_BMVVIDEO           VLC_FOURCC('B','M','V','V')
#define MX_CODEC_UTVIDEO            VLC_FOURCC('U','L','R','A')
#define MX_CODEC_VBLE               VLC_FOURCC('V','B','L','E')
#define MX_CODEC_DXTORY             VLC_FOURCC('x','t','o','r')
#define MX_CODEC_MSS1               VLC_FOURCC('M','S','S','1')
#define MX_CODEC_MSS2               VLC_FOURCC('M','S','S','2')
#define MX_CODEC_MSA1               VLC_FOURCC('M','S','A','1')
#define MX_CODEC_TSC2               VLC_FOURCC('T','S','C','2')
#define MX_CODEC_MTS2               VLC_FOURCC('M','T','S','2')
#define MX_CODEC_HEVC               VLC_FOURCC('h','e','v','c')
#define MX_CODEC_ICOD               VLC_FOURCC('i','c','o','d')
#define MX_CODEC_G2M2               VLC_FOURCC('G','2','M','2')
#define MX_CODEC_G2M3               VLC_FOURCC('G','2','M','3')
#define MX_CODEC_G2M4               VLC_FOURCC('G','2','M','4')
#define MX_CODEC_BINKVIDEO          VLC_FOURCC('B','I','K','f')
#define MX_CODEC_BINKAUDIO_DCT      VLC_FOURCC('B','A','U','1')
#define MX_CODEC_BINKAUDIO_RDFT     VLC_FOURCC('B','A','U','2')
#define MX_CODEC_XAN_WC4            VLC_FOURCC('X','x','a','n')
#define MX_CODEC_LCL_MSZH           VLC_FOURCC('M','S','Z','H')
#define MX_CODEC_LCL_ZLIB           VLC_FOURCC('Z','L','I','B')
#define MX_CODEC_THP                VLC_FOURCC('T','H','P','0')
#define MX_CODEC_ESCAPE124          VLC_FOURCC('E','1','2','4')
#define MX_CODEC_KGV1               VLC_FOURCC('K','G','V','1')
#define MX_CODEC_CLLC               VLC_FOURCC('C','L','L','C')
#define MX_CODEC_AURA               VLC_FOURCC('A','U','R','A')
#define MX_CODEC_FIC                VLC_FOURCC('F','I','C','V')
#define MX_CODEC_TMV                VLC_FOURCC('T','M','A','V')
#define MX_CODEC_XAN_WC3            VLC_FOURCC('X','A','N','3')
#define MX_CODEC_WS_VQA             VLC_FOURCC('W','V','Q','A')
#define MX_CODEC_MMVIDEO            VLC_FOURCC('M','M','V','I')
#define MX_CODEC_AVS                VLC_FOURCC('A','V','S','V')
#define MX_CODEC_DSICINVIDEO        VLC_FOURCC('D','C','I','V')
#define MX_CODEC_TIERTEXSEQVIDEO    VLC_FOURCC('T','S','E','Q')
#define MX_CODEC_DXA                VLC_FOURCC('D','E','X','A')
#define MX_CODEC_C93                VLC_FOURCC('I','C','9','3')
#define MX_CODEC_BETHSOFTVID        VLC_FOURCC('B','V','I','D')
#define MX_CODEC_VB                 VLC_FOURCC('V','B','V','1')
#define MX_CODEC_RL2                VLC_FOURCC('R','L','V','2')
#define MX_CODEC_BFI                VLC_FOURCC('B','F','&','I')
#define MX_CODEC_CMV                VLC_FOURCC('E','C','M','V')
#define MX_CODEC_MOTIONPIXELS       VLC_FOURCC('M','P','I','X')
#define MX_CODEC_TGV                VLC_FOURCC('T','G','V','V')
#define MX_CODEC_TGQ                VLC_FOURCC('T','G','Q','V')
#define MX_CODEC_TQI                VLC_FOURCC('T','Q','I','V')
#define MX_CODEC_MAD                VLC_FOURCC('M','A','D','V')
#define MX_CODEC_ANM                VLC_FOURCC('A','N','I','M')
#define MX_CODEC_YOP                VLC_FOURCC('Y','O','P','V')
#define MX_CODEC_JV                 VLC_FOURCC('J','V','0','0')
#define MX_CODEC_DFA                VLC_FOURCC('D','F','I','A')
#define MX_CODEC_HNM4_VIDEO         VLC_FOURCC('H','N','M','4')
#define MX_CODEC_TDSC               VLC_FOURCC('T','D','S','C')
#define MX_CODEC_HQX                VLC_FOURCC('C','H','Q','X')
#define MX_CODEC_HQ_HQA             VLC_FOURCC('C','U','V','C')
#define MX_CODEC_HAP                VLC_FOURCC('H','A','P','1')
#define MX_CODEC_DXV                VLC_FOURCC('D','X','D','3')
#define MX_CODEC_CINEFORM           VLC_FOURCC('C','F','H','D')
#define MX_CODEC_SPEEDHQ            VLC_FOURCC('S','H','Q','2')
#define MX_CODEC_PIXLET             VLC_FOURCC('p','x','l','t')


/* Audio codec */
#define MX_CODEC_MPGA               VLC_FOURCC('m','p','g','a')
#define MX_CODEC_MP4A               VLC_FOURCC('m','p','4','a')
#define MX_CODEC_MP2                VLC_FOURCC('m','p','2',' ')
#define MX_CODEC_MP3                VLC_FOURCC('m','p','3',' ')
#define MX_CODEC_ALS                VLC_FOURCC('a','l','s',' ')
#define MX_CODEC_A52                VLC_FOURCC('a','5','2','b')//VLC_FOURCC('a','5','2',' ')
#define MX_CODEC_EAC3               VLC_FOURCC('e','a','c','3')
#define MX_CODEC_DTS                VLC_FOURCC('d','t','s','b')//VLC_FOURCC('d','t','s',' ')
#define MX_CODEC_WMA1               VLC_FOURCC('W','M','A','1')
#define MX_CODEC_WMA2               VLC_FOURCC('W','M','A','2')
#define MX_CODEC_WMAP               VLC_FOURCC('W','M','A','P')
#define MX_CODEC_WMAL               VLC_FOURCC('W','M','A','L')
#define MX_CODEC_WMAS               VLC_FOURCC('W','M','A','S')
#define MX_CODEC_FLAC               VLC_FOURCC('f','l','a','c')
#define MX_CODEC_MLP                VLC_FOURCC('m','l','p',' ')
#define MX_CODEC_TRUEHD             VLC_FOURCC('t','r','h','d')
#define MX_CODEC_DVAUDIO            VLC_FOURCC('d','v','a','u')
#define MX_CODEC_SPEEX              VLC_FOURCC('s','p','x',' ')
#define MX_CODEC_OPUS               VLC_FOURCC('O','p','u','s')
#define MX_CODEC_VORBIS             VLC_FOURCC('v','o','r','b')
#define MX_CODEC_MACE3              VLC_FOURCC('M','A','C','3')
#define MX_CODEC_MACE6              VLC_FOURCC('M','A','C','6')
#define MX_CODEC_MUSEPACK7          VLC_FOURCC('M','P','C',' ')
#define MX_CODEC_MUSEPACK8          VLC_FOURCC('M','P','C','K')
#define MX_CODEC_RA_144             VLC_FOURCC('1','4','_','4')
#define MX_CODEC_RA_288             VLC_FOURCC('2','8','_','8')
#define MX_CODEC_INTERPLAY_DPCM     VLC_FOURCC('i','d','p','c')
#define MX_CODEC_ROQ_DPCM           VLC_FOURCC('R','o','Q','a')
#define MX_CODEC_DSICINAUDIO        VLC_FOURCC('D','C','I','A')
#define MX_CODEC_ADPCM_4XM          VLC_FOURCC('4','x','m','a')
#define MX_CODEC_ADPCM_EA           VLC_FOURCC('A','D','E','A') // VLC_FOURCC('X','A','J', 0)
#define MX_CODEC_ADPCM_XA           VLC_FOURCC('x','a',' ',' ')
#define MX_CODEC_ADPCM_ADX          VLC_FOURCC('a','d','x',' ')
#define MX_CODEC_ADPCM_IMA_WS       VLC_FOURCC('A','I','W','S')
#define MX_CODEC_ADPCM_G722         VLC_FOURCC('g','7','2','2')
#define MX_CODEC_ADPCM_G726         VLC_FOURCC('g','7','2','6')
#define MX_CODEC_ADPCM_SWF          VLC_FOURCC('S','W','F','a')
#define MX_CODEC_ADPCM_MS           VLC_FOURCC('m','s',0x00,0x02)
#define MX_CODEC_ADPCM_IMA_WAV      VLC_FOURCC('m','s',0x00,0x11)
#define MX_CODEC_ADPCM_IMA_AMV      VLC_FOURCC('i','m','a','v')
#define MX_CODEC_ADPCM_IMA_QT       VLC_FOURCC('i','m','a','4')
#define MX_CODEC_ADPCM_YAMAHA       VLC_FOURCC('m','s',0x00,0x20)
#define MX_CODEC_ADPCM_DK3          VLC_FOURCC('m','s',0x00,0x62)
#define MX_CODEC_ADPCM_DK4          VLC_FOURCC('m','s',0x00,0x61)
#define MX_CODEC_ADPCM_CREATIVE     VLC_FOURCC('m','s',0x00,0xC0)
#define MX_CODEC_ADPCM_SBPRO_2      VLC_FOURCC('m','s',0x00,0xC2)
#define MX_CODEC_ADPCM_SBPRO_3      VLC_FOURCC('m','s',0x00,0xC3)
#define MX_CODEC_ADPCM_SBPRO_4      VLC_FOURCC('m','s',0x00,0xC4)
#define MX_CODEC_ADPCM_THP          VLC_FOURCC('T','H','P','A')
#define MX_CODEC_ADPCM_XA_EA        VLC_FOURCC('X','A','J', 0)
#define MX_CODEC_G723_1             VLC_FOURCC('g','7','2', 0x31)
#define MX_CODEC_G729               VLC_FOURCC('g','7','2','9')
//#define MX_CODEC_SOWT               VLC_FOURCC('s','o','w','t') // ???
//#define MX_CODEC_TWOS               VLC_FOURCC('t','w','o','s') // ???
#define MX_CODEC_AAC	            VLC_FOURCC('a','a','c',' ') // ???
#define MX_CODEC_VMDAUDIO           VLC_FOURCC('v','m','d','a')
#define MX_CODEC_AMR_NB             VLC_FOURCC('s','a','m','r')
#define MX_CODEC_AMR_WB             VLC_FOURCC('s','a','w','b')
#define MX_CODEC_ALAC               VLC_FOURCC('a','l','a','c')
#define MX_CODEC_QDM2               VLC_FOURCC('Q','D','M','2')
#define MX_CODEC_QDMC               VLC_FOURCC('Q','D','M','C')
#define MX_CODEC_COOK               VLC_FOURCC('c','o','o','k')
#define MX_CODEC_SIPR               VLC_FOURCC('s','i','p','r')
#define MX_CODEC_TTA                VLC_FOURCC('T','T','A','1')
#define MX_CODEC_SHORTEN            VLC_FOURCC('s','h','n',' ')
#define MX_CODEC_WAVPACK            VLC_FOURCC('W','V','P','K')
#define MX_CODEC_GSM                VLC_FOURCC('g','s','m',' ')
#define MX_CODEC_GSM_MS             VLC_FOURCC('a','g','s','m')
#define MX_CODEC_ATRAC1             VLC_FOURCC('a','t','r','1')
#define MX_CODEC_ATRAC3             VLC_FOURCC('a','t','r','c')
#define MX_CODEC_ATRAC3P            VLC_FOURCC('a','t','r','p')
#define MX_CODEC_SONIC              VLC_FOURCC('S','O','N','C') // ???
#define MX_CODEC_IMC                VLC_FOURCC(0x1,0x4,0x0,0x0)
#define MX_CODEC_TRUESPEECH         VLC_FOURCC(0x22,0x0,0x0,0x0)
#define MX_CODEC_NELLYMOSER         VLC_FOURCC('N','E','L','L')
#define MX_CODEC_APE                VLC_FOURCC('A','P','E',' ')
#define MX_CODEC_QCELP              VLC_FOURCC('Q','c','l','p')
#define MX_CODEC_302M               VLC_FOURCC('3','0','2','m')
#define MX_CODEC_DVD_LPCM           VLC_FOURCC('l','p','c','b')//VLC_FOURCC('l','p','c','m')
#define MX_CODEC_DVDA_LPCM          VLC_FOURCC('a','p','c','m')
#define MX_CODEC_BD_LPCM            VLC_FOURCC('b','p','c','m')
#define MX_CODEC_WIDI_LPCM          VLC_FOURCC('w','p','c','m')
#define MX_CODEC_SDDS               VLC_FOURCC('s','d','d','s')
#define MX_CODEC_MIDI               VLC_FOURCC('M','I','D','I')
#define MX_CODEC_RALF               VLC_FOURCC('R','A','L','F')

#define MX_CODEC_S8                 VLC_FOURCC('s','8',' ',' ')
#define MX_CODEC_U8                 VLC_FOURCC('u','8',' ',' ')
#define MX_CODEC_S16L               VLC_FOURCC('s','1','6','l')
#define MX_CODEC_S16L_PLANAR        VLC_FOURCC('s','1','l','p')
#define MX_CODEC_S16B               VLC_FOURCC('s','1','6','b')
#define MX_CODEC_U16L               VLC_FOURCC('u','1','6','l')
#define MX_CODEC_U16B               VLC_FOURCC('u','1','6','b')
#define MX_CODEC_S20B               VLC_FOURCC('s','2','0','b')
#define MX_CODEC_S24L               VLC_FOURCC('s','2','4','l')
#define MX_CODEC_S24B               VLC_FOURCC('s','2','4','b')
#define MX_CODEC_U24L               VLC_FOURCC('u','2','4','l')
#define MX_CODEC_U24B               VLC_FOURCC('u','2','4','b')
#define MX_CODEC_S24L32             VLC_FOURCC('s','2','4','4')
#define MX_CODEC_S24B32             VLC_FOURCC('S','2','4','4')
#define MX_CODEC_S32L               VLC_FOURCC('s','3','2','l')
#define MX_CODEC_S32B               VLC_FOURCC('s','3','2','b')
#define MX_CODEC_U32L               VLC_FOURCC('u','3','2','l')
#define MX_CODEC_U32B               VLC_FOURCC('u','3','2','b')
#define MX_CODEC_F32L               VLC_FOURCC('f','3','2','l')
#define MX_CODEC_F32B               VLC_FOURCC('f','3','2','b')
#define MX_CODEC_F64L               VLC_FOURCC('f','6','4','l')
#define MX_CODEC_F64B               VLC_FOURCC('f','6','4','b')

#define MX_CODEC_ALAW               VLC_FOURCC('a','l','a','w')
#define MX_CODEC_MULAW              VLC_FOURCC('m','l','a','w')
#define MX_CODEC_DAT12              VLC_FOURCC('L','P','1','2')
#define MX_CODEC_S24DAUD            VLC_FOURCC('d','a','u','d')
#define MX_CODEC_FI32               VLC_FOURCC('f','i','3','2') // ???
#define MX_CODEC_TWINVQ             VLC_FOURCC('T','W','I','N')
#define MX_CODEC_BMVAUDIO           VLC_FOURCC('B','M','V','A')
#define MX_CODEC_ULEAD_DV_AUDIO_NTSC VLC_FOURCC('m','s',0x02,0x15)
#define MX_CODEC_ULEAD_DV_AUDIO_PAL VLC_FOURCC('m','s',0x02,0x16)
#define MX_CODEC_INDEO_AUDIO        VLC_FOURCC('m','s',0x04,0x02)
#define MX_CODEC_METASOUND          VLC_FOURCC('m','s',0x00,0x75)
#define MX_CODEC_ON2AVC             VLC_FOURCC('m','s',0x05,0x00)
#define MX_CODEC_TAK                VLC_FOURCC('t','a','k',' ')
#define MX_CODEC_SMACKAUDIO         VLC_FOURCC('S','M','K','A')
#define MX_CODEC_ADPCM_IMA_EA_SEAD  VLC_FOURCC('S','E','A','D')
#define MX_CODEC_ADPCM_EA_R1        VLC_FOURCC('E','A','R','1')
#define MX_CODEC_ADPCM_IMA_APC      VLC_FOURCC('A','I','P','C')
/* Subtitle */
#define MX_CODEC_SPU                VLC_FOURCC('s','p','u','b')//VLC_FOURCC('s','p','u',' ')
#define MX_CODEC_DVBS               VLC_FOURCC('d','v','b','s')
#define MX_CODEC_SUBT               VLC_FOURCC('s','u','b','t')
#define MX_CODEC_XSUB               VLC_FOURCC('X','S','U','B')
#define MX_CODEC_SSA                VLC_FOURCC('s','s','a',' ')
#define MX_CODEC_TEXT               VLC_FOURCC('T','E','X','T')
#define MX_CODEC_TELETEXT           VLC_FOURCC('t','e','l','x')
#define MX_CODEC_KATE               VLC_FOURCC('k','a','t','e')
#define MX_CODEC_CMML               VLC_FOURCC('c','m','m','l')
#define MX_CODEC_ITU_T140           VLC_FOURCC('t','1','4','0')
#define MX_CODEC_USF                VLC_FOURCC('u','s','f',' ')
#define MX_CODEC_OGT                VLC_FOURCC('o','g','t',' ')
#define MX_CODEC_CVD                VLC_FOURCC('c','v','d',' ')
#define MX_CODEC_TX3G               VLC_FOURCC('t','x','3','g')
#define MX_CODEC_ARIB_A             VLC_FOURCC('a','r','b','a')
#define MX_CODEC_ARIB_C             VLC_FOURCC('a','r','b','c')
/* Blu-ray Presentation Graphics */
#define MX_CODEC_BD_PG              VLC_FOURCC('b','d','p','g')
#define MX_CODEC_BD_TEXT            VLC_FOURCC('b','d','t','x')
/* EBU STL (TECH. 3264-E) */
#define MX_CODEC_EBU_STL            VLC_FOURCC('S','T','L',' ')
#define MX_CODEC_SCTE_18            VLC_FOURCC('S','C','1','8')
#define MX_CODEC_SCTE_27            VLC_FOURCC('S','C','2','7')
/* EIA-608 */
#define MX_CODEC_EIA608_1           VLC_FOURCC('c','c','1',' ')
#define MX_CODEC_EIA608_2           VLC_FOURCC('c','c','2',' ')
#define MX_CODEC_EIA608_3           VLC_FOURCC('c','c','3',' ')
#define MX_CODEC_EIA608_4           VLC_FOURCC('c','c','4',' ')
/* EIA/CEA-608/708 */
#define MX_CODEC_CEA608             VLC_FOURCC('c','6','0','8')
#define MX_CODEC_CEA708             VLC_FOURCC('c','7','0','8')
#define MX_CODEC_TTML               VLC_FOURCC('T','T','M','L')
#define MX_CODEC_WEBVTT             VLC_FOURCC('w','v','t','t')
/**
