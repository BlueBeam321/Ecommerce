 ...
 */
#ifdef __cplusplus
#define VLC_OBJECT(x) (x ? ((vlc_object_t*)&(x)->obj) : NULL)
#else
...
static inline bool uaddl_overflow(unsigned long a, unsigned long b, unsigned long *res)
{
     *res = a + b;
     return (a + b) < a;
}

static inline bool uaddll_overflow(unsigned long long a, unsigned long long b, unsigned long long *res)
{
     *res = a + b;
     return (a + b) < a;
}
...
static inline bool umull_overflow(unsigned long a, unsigned long b, unsigned long *res)
{
     *res = a * b;
     return b > 0 && a > (ULONG_MAX / b);
}

static inline bool umulll_overflow(unsigned long long a, unsigned long long b, unsigned long long *res)
{
     *res = a * b;
...
static inline uint8_t U8_AT(void const * _p)
{
