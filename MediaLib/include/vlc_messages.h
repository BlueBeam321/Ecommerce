...
VLC_API void vlc_Log(vlc_object_t *obj, int prio,
                     const char *file, unsigned line, const char *func,
                     const char *format, ...) VLC_FORMAT(6, 7);
VLC_API void vlc_vaLog(vlc_object_t *obj, int prio,
                       const char *file, unsigned line, const char *func,
                       const char *format, va_list ap);
#define msg_GenericVa(o, p, fmt, ap) \
    vlc_vaLog(VLC_OBJECT(o), p, __FILE__, __LINE__, \
              __FUNCTION__, fmt, ap)

#define msg_Generic(o, p, ...) \
    vlc_Log(VLC_OBJECT(o), p, __FILE__, __LINE__, \
