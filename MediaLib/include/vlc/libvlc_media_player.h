 ...
 */
LIBVLC_API int libvlc_video_get_spu( libvlc_media_player_t *p_mi, bool b_sub );
 ...
 */
LIBVLC_API int libvlc_video_set_spu( libvlc_media_player_t *p_mi, int i_spu, bool b_sub );
...
*
* \param p_mi media player
* \param program the media program number
* \return 0 on success, -1 on error
*/
LIBVLC_API int libvlc_media_player_change_program(libvlc_media_player_t *p_mi,
                                                  int program);
/**
...
* \return 0 on success, -1 on error
*/
LIBVLC_API int libvlc_media_player_get_program_info(libvlc_media_player_t *p_mi, 
                                                    int index,  int *p_number, char *p_name);


/**
* Set the program scramble flag.
*
* \param p_mi media player
* \param program the media program number
*/
...
/**
* Get the stream time form dvbpsi_tdt.
*
* \param p_mi media player
* \param program the media program number
* \return 0 on success, -1 on error
