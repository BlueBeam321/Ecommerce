...
enum demux_query_e
{
    ...
    /* Added by K.C.Y */
    DEMUX_GET_VOD_FMT_BY_ID,
    DEMUX_GET_VOD_FMT_CODEC,
    DEMUX_GET_VOD_FMT_EXTRA,
    DEMUX_GET_VOD_FMT_ORG_FOURCC,
    DEMUX_GET_VOD_FMT_DESC,
    DEMUX_GET_VOD_FMT_LANG,
    DEMUX_GET_VOD_FMT_VIDEO_PALETTE,
    DEMUX_GET_VOD_FMT_SPU_PALETTE,
    DEMUX_GET_VOD_FMT_SPU_ORG_SIZE
};
