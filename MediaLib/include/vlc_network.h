 ...
 */
VLC_API int vlc_socket(int pf, int type, int proto, bool nonblock);
...
/* Added by K.C.Y */
VLC_API int  net_IGMPOpen(void);
VLC_API void net_IGMPClose(int fd);
VLC_API void net_IGMPSend(int fd, uint32_t grp);
