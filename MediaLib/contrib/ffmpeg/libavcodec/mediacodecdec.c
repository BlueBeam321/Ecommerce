...
static av_cold int mediacodec_decode_init(AVCodecContext *avctx)
{
    ...
    // Added new
    ff_AMediaFormat_setInt32(format, "max-input-size", avctx->width * avctx->height);
    ff_AMediaFormat_setInt32(format, "max-width", avctx->width);
    ff_AMediaFormat_setInt32(format, "max-height", avctx->width);
