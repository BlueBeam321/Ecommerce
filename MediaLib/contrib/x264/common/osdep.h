...
#else
#define log2f(x) ((float)(log(x) * 1.44269504088896340736))
#endif
...
#define ALIGNED_ARRAY_EMU( mask, type, name, sub1, __VA_ARGS__ )\
...
#if defined(WIN32) && !defined(_VS2010_)
#define ALIGNED_ARRAY_8( type, name, sub1, __VA_ARGS__ )\
    ALIGNED_8( type name sub1 __VA_ARGS__ )
#elif ARCH_ARM && SYS_MACOSX
...
#if defined(WIN32) && !defined(_VS2010_)
#define ALIGNED_ARRAY_16( type, name, sub1, __VA_ARGS__ )\
...
#if defined(WIN32) && !defined(_VS2010_)
#define ALIGNED_ARRAY_32( type, name, sub1, __VA_ARGS__ )\
...
#if defined(WIN32) && !defined(_VS2010_)
#define ALIGNED_ARRAY_64( __VA_ARGS__ ) EXPAND( ALIGNED_ARRAY_EMU( 63, __VA_ARGS__ ) )
#else
