...
#define INTRA_MBCMP_8x8_1( mbcmp, cpu2 )\
void x264_intra_##mbcmp##_x3_8x8( pixel *fenc, pixel edge[36], int res[3] )\
{\
    ALIGNED_ARRAY_16( pixel, pix, [8*FDEC_STRIDE] );\
    x264_predict_8x8_v##cpu2( pix, edge );\
...
INTRA_MBCMP_8x8_1( sad, _c )
INTRA_MBCMP_8x8_1(sa8d, _c )
...
#define INTRA_MBCMP_1( mbcmp, size, pred1, pred2, pred3, chroma, cpu2 )\
...
#define INTRA_MBCMP_2( mbcmp, size, pred1, pred2, pred3, cpu2 )\
...
INTRA_MBCMP_2( sad,  4x4,   v, h, dc,     _c )
INTRA_MBCMP_2(satd,  4x4,   v, h, dc,     _c )
INTRA_MBCMP_1( sad,  8x8,  dc, h,  v, c,  _c )
INTRA_MBCMP_1(satd,  8x8,  dc, h,  v, c,  _c )
INTRA_MBCMP_1( sad,  8x16, dc, h,  v, c,  _c )
INTRA_MBCMP_1(satd,  8x16, dc, h,  v, c,  _c )
INTRA_MBCMP_2( sad, 16x16,  v, h, dc,     _c )
INTRA_MBCMP_2(satd, 16x16,  v, h, dc,     _c )
