...
#define CLIP_ADD(s,x) (s) = X264_MIN((s)+(x),(1<<15)-1)
        int listamount, lists_used;
        unsigned mbx,mby,idx0,idx2;
        int x,y,idx0weight,idx1weight,idx2weight,idx3weight;

        lists_used = lowres_costs[i]>>LOWRES_COST_SHIFT;
