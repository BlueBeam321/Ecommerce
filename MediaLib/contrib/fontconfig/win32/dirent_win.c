...
int GetFontDirectory2(unsigned char* fontDir)
{
    if (SHGetFolderPathA(NULL, CSIDL_APPDATA | CSIDL_FLAG_CREATE, NULL, 0, (LPSTR)fontDir) >= 0)
    {
        PathAppendA((LPSTR)fontDir, "..\\Local\\Microsoft\\Windows\\Fonts");
        //SHCreateDirectoryEx(NULL, fontDir, NULL);
    }
    return 0;
}
#endif
