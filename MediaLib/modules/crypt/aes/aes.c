...
* AES - CBC
*******************/
int aes_encrypt_cbc(const BYTE in[], size_t in_len, BYTE out[], const AES_WORD key[], int keysize, const BYTE iv[])
{
...
int aes_encrypt_cbc_mac(const BYTE in[], size_t in_len, BYTE out[], const AES_WORD key[], int keysize, const BYTE iv[])
{
	BYTE buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE], iv_buf[AES_BLOCK_SIZE];
	int blocks, idx;
...
int aes_decrypt_cbc(const BYTE in[], size_t in_len, BYTE out[], const AES_WORD key[], int keysize, const BYTE iv[])
{
	BYTE buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE], iv_buf[AES_BLOCK_SIZE];
	int blocks, idx;
...
void aes_encrypt_ctr(const BYTE in[], size_t in_len, BYTE out[], const AES_WORD key[], int keysize, const BYTE iv[])
{
...
void aes_decrypt_ctr(const BYTE in[], size_t in_len, BYTE out[], const AES_WORD key[], int keysize, const BYTE iv[])
{
...
int aes_encrypt_ccm(const BYTE payload[], AES_WORD payload_len, const BYTE assoc[], unsigned short assoc_len,
                    const BYTE nonce[], unsigned short nonce_len, BYTE out[], AES_WORD *out_len,
                    AES_WORD mac_len, const BYTE key_str[], int keysize)
{
...
int aes_decrypt_ccm(const BYTE ciphertext[], AES_WORD ciphertext_len, const BYTE assoc[], unsigned short assoc_len,
                    const BYTE nonce[], unsigned short nonce_len, BYTE plaintext[], AES_WORD *plaintext_len,
                    AES_WORD mac_len, int *mac_auth, const BYTE key_str[], int keysize)
{
