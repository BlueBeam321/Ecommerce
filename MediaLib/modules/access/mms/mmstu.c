 ...
 * Block:
 *****************************************************************************/
static block_t *Block( stream_t *p_access, bool * eof )
{
    access_sys_t *p_sys = p_access->p_sys;
...
static void KeepAliveStart( stream_t *p_access )
{
    ...
    p_sys->b_keep_alive = !vlc_clone(&p_sys->keep_alive, KeepAliveThread, p_access, "access_mmstu_keepalive", VLC_THREAD_PRIORITY_LOW);
}
