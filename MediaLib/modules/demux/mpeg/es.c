...
#include "common/modules/packetizer/a52.h"
#include "common/modules/packetizer/dts_header.h"
#include "common/modules/meta_engine/ID3Tag.h"
#include "common/modules/meta_engine/ID3Text.h"
#include "common/modules/meta_engine/ID3Meta.h"

#define MODULE_NAME     demux_audio_es
#define MODULE_STRING   "demux_audio_es"
    ...
    if( i_tag == VLC_FOURCC('M', 'L', 'L', 'T') )
    {
        if( i_payload > 20 )
        {
            ...
            if( likely(p_sys->mllt.p_bits) )
            {
                ...
                msg_Dbg(p_demux, "read MLLT sync table with %d entries",
