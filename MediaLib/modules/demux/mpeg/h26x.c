...
#include <vlc_demux.h>
#include <vlc_codec.h>
#include "common/modules/packetizer/hevc_nal.h" /* definitions, inline helpers */
#include "common/modules/packetizer/h264_nal.h" /* definitions, inline helpers */

#define MODULE_NAME     demux_h264
#define MODULE_STRING   "demux_h264"
