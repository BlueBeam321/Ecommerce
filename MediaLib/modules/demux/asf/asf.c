...
#include "common/modules/demux/asf/libasf_guid.h"
#include "common/modules/demux/asf/libasf.h"
#include "common/modules/demux/asf/asfpacket.h"
#include <assert.h>

#define MODULE_NAME     demux_asf
#define MODULE_STRING   "demux_asf"
