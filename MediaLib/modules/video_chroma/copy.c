...
#include "common/modules/video_chroma/copy.h"
...
static void SSE_Copy420_P_to_P(picture_t *dst, const uint8_t *src[3],
...
static void SSE_Copy420_SP_to_SP(picture_t *dst, const uint8_t *src[2],
...
static void
SSE_Copy420_SP_to_P(picture_t *dest, const uint8_t *src[2],
                    const size_t src_pitch[2], unsigned int height,
...
static void SSE_Copy420_P_to_SP(picture_t *dst, const uint8_t *src[3],
