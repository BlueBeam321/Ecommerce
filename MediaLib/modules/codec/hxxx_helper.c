...
#include "common/modules/packetizer/hxxx_nal.h"
#include "common/modules/packetizer/h264_slice.h"
...
{
    const struct hxxx_helper_nal *p_nal;
    const uint8_t *pp_sps_bufs[256/*hh->h264.i_sps_count*/];
    size_t p_sps_sizes[256/*hh->h264.i_sps_count*/];
    ...
    const uint8_t *pp_pps_bufs[256/*hh->h264.i_pps_count*/];
    size_t p_pps_sizes[256/*hh->h264.i_pps_count*/];
...
hevc_helper_get_hvcc_config(const struct hxxx_helper *hh)
{
    ...
    memset(&params, 0, sizeof(struct hevc_dcr_params));
