...
#include "common/modules/packetizer/hxxx_nal.h" /* colour values/mappings */

#define MODULE_NAME     packetizer_mpeg4video
#define MODULE_STRING   "packetizer_mpeg4video"
...
static block_t *ParseMPEGBlock( decoder_t *p_dec, block_t *p_frag )
{
             ...
             i_startcode < RESERVED_START_CODE )
    {
        ...
        {
            p_dec->fmt_out.p_extra = realloc(p_dec->fmt_out.p_extra, p_frag->i_buffer);
