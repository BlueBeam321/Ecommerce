...
#define MODULE_NAME     vout_directdraw
#define MODULE_STRING   "vout_directdraw"
                                        ...
                                        HMONITOR hmon)
{
    ...
    char *psz_drivername = drivername;
    ctx->values = realloc(ctx->values, (ctx->count + 1) * sizeof(char *));
    ctx->descs = realloc(ctx->descs, (ctx->count + 1) * sizeof(char *));
